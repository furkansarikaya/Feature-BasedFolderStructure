...
internal class LoginCommandHandler(IApplicationUserService applicationUserService,ITokenService tokenService) : IRequestHandler<LoginCommand, LoginDto>
{
    public async Task<LoginDto> HandleAsync(LoginCommand request, CancellationToken cancellationToken)
    {
