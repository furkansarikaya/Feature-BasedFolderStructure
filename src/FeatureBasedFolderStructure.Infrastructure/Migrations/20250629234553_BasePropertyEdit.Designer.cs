...
namespace FeatureBasedFolderStructure.Infrastructure.Migrations
{
    ...
    [Migration("20250629234553_BasePropertyEdit")]
    partial class BasePropertyEdit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeatureBasedFolderStructure.Domain.Entities.Users.UserToken", b =>
                {
                    ...
                    b.HasIndex("UserId", "TokenType", "TokenValue")
                        .IsUnique()
                        .HasDatabaseName("ix_user_tokens_user_id_token_type_token_value");
            ...
            modelBuilder.Entity("FeatureBasedFolderStructure.Domain.Entities.Catalogs.Product", b =>
                {
                    ...
                    b.OwnsOne("FeatureBasedFolderStructure.Domain.ValueObjects.Catalogs.Money", "CurrentPrice", b1 =>
                        {
            ...
            modelBuilder.Entity("FeatureBasedFolderStructure.Domain.Entities.Orders.Order", b =>
                {
                    b.OwnsOne("FeatureBasedFolderStructure.Domain.ValueObjects.Orders.Address", "ShippingAddress", b1 =>
                        {
